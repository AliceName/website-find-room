...
export default function PostCard({ post }: PostCardProps) {
    ...
    return (
        <div className="group block h-full">
            <div className="flex h-full cursor-pointer flex-col overflow-hidden rounded-3xl border border-app bg-surface shadow-sm transition-all duration-[220ms] ease-[var(--ease-out-quart)] hover:-translate-y-1 hover:shadow-lg focus-within:ring-2 focus-within:ring-blue-500/20">
                {/* Hình ảnh */}
